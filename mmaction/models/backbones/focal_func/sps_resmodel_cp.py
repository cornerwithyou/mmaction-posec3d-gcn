...
class spsresnet(nn.Module):
    def __init__(
        ...
        self.conv_input = spconv.SparseSequential(
            spconv.SparseConv3d(num_input_features, 32, kernel_size=(1,7,7),stride=(1, 1, 1), padding=(0, 3, 3), bias=False, indice_key="res0"),
        ...
        self.layer2 = SparseSequentialBatchdict(
            SparseBasicBlock2(128,64, 256, norm_cfg=norm_cfg, indice_key="layer10",visualize_file="backbone_model_layer2_0_relu2"),
            pool2,
        ...
        self.layer3 = SparseSequentialBatchdict(
            SparseBasicBlock2(256,128, 512, norm_cfg=norm_cfg, indice_key="layer20",visualize_file="backbone_model_layer3/0/relu2"),
            pool1,
            pool2,
