...
class SpMiddleResNetFHD(nn.Module):
    def __init__(
        ...
        #     spconv.SparseConv3d(17,out_channels=32,kernel_size=(1,7,7),stride=(1,1,1),padding=(0,3,3),bias=False),
    ...
    def forward(self, x):
        ...
        ret = x
        # ret = spconv.SparseConvTensor.from_dense(x.permute(0,2,3,4,1))
