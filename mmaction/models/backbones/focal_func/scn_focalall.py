...
class SparseBasicBlock1(spconv.SparseModule):
    def __init__(
        ...
        self.conv1 = conv1x1(inplanes, midplanes, indice_key=indice_key + "1",norm_cfg=norm_cfg,  bias=bias)
    ...
    def forward(self, x):
        ...
        # print('ide  ',identity.dense().shape)
...
class SparseBasicBlock2(spconv.SparseModule):
    def __init__(
        ...
        self.conv1 = conv311(inplanes, midplanes, indice_key=indice_key+"1",norm_cfg=norm_cfg,  bias=bias)
        self.bn1 = build_norm_layer(norm_cfg, midplanes)[1]
        self.relu1 = nn.ReLU()
        self.relu2 = nn.ReLU()
...
class spsconvall(nn.Module):
    def __init__(
        ...
        self.layer3 = SparseSequentialBatchdict(
            SparseBasicBlock2(256,128, 512, norm_cfg=norm_cfg, indice_key="layer22",visualize_file="backbone_model_layer3_0_relu2"),
            pool1,
            pool2,
