...
class SparseBasicBlock1(spconv.SparseModule):
    def __init__(
        ...
        self.relu1 = nn.ReLU()
        self.relu2 = nn.ReLU()
        self.conv2 = conv3x3(inplanes, planes,stride=(1, 2, 2), indice_key=indice_key + "3",norm_cfg=norm_cfg, bias=bias)
...
class SparseBasicBlock2(spconv.SparseModule):
    def __init__(
        ...
        self.conv2 = conv3x3(midplanes, planes, indice_key=indice_key+"2",norm_cfg=norm_cfg, bias=bias)
        self.bn2 = build_norm_layer(norm_cfg, planes)[1]
...
class SubMConv(nn.Module):
    def __init__(
        ...
        self.layer1 = SparseSequentialBatchdict(
            ...
            SparseBasicBlock1(128, 32,128 ,norm_cfg=norm_cfg, indice_key="layer01",visualize=True),
            SparseBasicBlock1(128, 32,128 ,norm_cfg=norm_cfg, indice_key="layer01"),
        )
